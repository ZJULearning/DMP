...
Markers = ['but', 'so', 'if', 'when', 'before', 'still', 'because', 'although']
...
def shuffle_data_set(src_path, save_path, word_indices):
    ...
    for key in data_set.keys():
        marker_type = key
        if marker_type not in Markers_map:
            continue
...
if __name__ == '__main__':
    ...
    vocab_path = "../bookcorpus/vocab.pkl.gz"    converted_data_set_path = "../bookcorpus/new_converted_data_set.pkl.gz"
